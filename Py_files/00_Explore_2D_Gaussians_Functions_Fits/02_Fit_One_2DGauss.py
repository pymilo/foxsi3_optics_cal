...
## Fitting a function requieres a *TRUE* set of data and an initial guess to
## then obtained a converged output. Here we mock a "True" 2D-Gaussian with some radom noise.
...
plt.show()
## Note that the errors between the True and the Output 2D-Gaussians are on the order of 1e-15
