...
plt.show()
# Print what the amplitude ratios are
...
print(
    'The standard deviation for the two 2D-Gaussians are: S1x = {0:.5f}, S1y = {1:.5f}, S2x = {2:.5f}, and S2y = {3:.5f}.'
